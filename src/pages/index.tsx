...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Digitron Savvy`}</title>

        <meta
          name="description"
          content="Digitron Savvy - Empowering Your Brand's Voice with Exceptional Social Media Marketing Services. Expand Your Reach, Engage Audiences, and Drive Success."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Digitron Savvy - Empowering Your Brand's Voice with Exceptional Social Media Marketing Services. Expand Your Reach, Engage Audiences, and Drive Success.`}
            </Text>
            <Box
